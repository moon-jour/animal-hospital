  ...
  if (sql) {
    ...
    const rows = await sql`
      INSERT INTO surgery_reviews (
        id, slug, title, category, breed, excerpt, admission_date, discharge_date, body, cover_image_url, cover_image_alt,
      ...
      VALUES (
        ...
        ${review.admissionDate || null}, ${review.dischargeDate || null}, ${review.body}, ${review.coverImageUrl}, ${review.coverImageAlt}, ${review.published},
